...
Aes.cipher = function(input, w) {
    var Nb = 4;               // block size (in words): num of columns in state 4for aes
    var Nr = w.length / Nb - 1; //rounds: 10/12/14 for 128/192/256-bit keys
...
Aes.keyExpansion = function(key) { //generate round keys from cipher key
...
if (typeof define == 'function' && define.amd) define(['Aes'], function() {
        return Aes.Ctr;
    });
